-- First creating new database to create new tables

Create database SQL_Homework5
use SQL_Homework5
...
Email VARCHAR(100), Phone VARCHAR(50), Address VARCHAR(255), City VARCHAR(100), 
State VARCHAR(100), PostalCode VARCHAR(20), Country VARCHAR(100) );
...
Insert Products_Discounted Values 
...
Insert OutOfStock Values 
(1, 'Gaming Console', 500.00, 'Electronics', 0), (2, 'Smartwatch', 250.00, 'Electronics', 0), 
(3, 'Wireless Earbuds', 150.00, 'Electronics', 0), (4, 'Projector', 700.00, 'Electronics', 0), 
(5, 'Mechanical Keyboard', 120.00, 'Accessories', 0), (6, 'Wireless Mouse', 45.00, 'Accessories', 0), 
(7, 'Office Chair', 250.00, 'Furniture', 0), (8, 'Standing Desk', 400.00, 'Furniture', 0), 
(9, 'Marker Set', 20.00, 'Stationery', 0), (10, 'Sketchbook', 35.00, 'Stationery', 0), 
(11, 'Scanner', 220.00, 'Electronics', 0), (12, 'Drone', 800.00, 'Electronics', 0), 
(13, 'Power Drill', 90.00, 'Tools', 0), (14, 'Sweater', 55.00, 'Clothing', 0), (15, 'Shorts', 30.00, 'Clothing', 0), 
(16, 'Raincoat', 75.00, 'Clothing', 0), (17, 'Sandals', 40.00, 'Clothing', 0), (18, 'Gloves', 15.00, 'Accessories', 0), 
(19, 'Necklace', 120.00, 'Accessories', 0), (20, 'Sunglasses', 80.00, 'Accessories', 0), 
(21, 'Bedside Lamp', 45.00, 'Furniture', 0), (22, 'Bookshelf', 150.00, 'Furniture', 0), 
(23, 'Dictionary', 25.00, 'Stationery', 0), (24, 'Wall Clock', 60.00, 'Furniture', 0), (25, 'Thermos', 35.00, 'Accessories', 0), 
(26, 'Backpack', 60.00, 'Accessories', 0), (27, 'Recliner', 550.00, 'Furniture', 0), (28, 'Freezer', 750.00, 'Electronics', 0), 
(29, 'Induction Cooktop', 300.00, 'Electronics', 0), (30, 'Oven', 600.00, 'Electronics', 0), 
(31, 'Humidifier', 90.00, 'Electronics', 0), (32, 'Vacuum Cleaner', 250.00, 'Electronics', 0),
(33, 'Electric Kettle', 45.00, 'Electronics', 0), (34, 'Smart Light Bulb', 30.00, 'Accessories', 0),
(35, 'Water Purifier', 120.00, 'Electronics', 0), (36, 'Popcorn Maker', 50.00, 'Electronics', 0), 
(37, 'Rice Cooker', 70.00, 'Electronics', 0), (38, 'Food Processor', 90.00, 'Electronics', 0), 
(39, 'Deep Fryer', 80.00, 'Electronics', 0), (40, 'Robot Vacuum', 500.00, 'Electronics', 0);
...
Create table Employees (  
     EmployeeID INT PRIMARY KEY, Name VARCHAR(100) NOT NULL, DepartmentName VARCHAR(100), Salary DECIMAL(10,2), Age INT);

Select * from Employees

Insert Employees VALUES  
(1, 'John Smith', 'HR', 55000.00, 28),  
(2, 'Alice Johnson', 'IT', 62000.00, 35),  
(3, 'Michael Brown', 'Sales', 48000.00, 29),  
(4, 'Emma Davis', 'HR', 71000.00, 41),  
(5, 'David Wilson', 'Finance', 53000.00, 32),  
(6, 'Sophia Martinez', 'IT', 60000.00, 37),  
(7, 'James Anderson', 'Sales', 47000.00, 26),  
(8, 'Olivia Thomas', 'HR', 75000.00, 45),  
(9, 'William Jackson', 'Finance', 52000.00, 31),  
(10, 'Ava White', 'IT', 58000.00, 39),  
(11, 'Liam Harris', 'HR', 72000.00, 44),  
(12, 'Isabella Martin', 'Sales', 49000.00, 30),  
(13, 'Noah Thompson', 'IT', 65000.00, 36),  
(14, 'Mia Robinson', 'Finance', 51000.00, 33),  
(15, 'Benjamin Clark', 'HR', 76000.00, 46),  
(16, 'Charlotte Lewis', 'Sales', 50000.00, 27),  
(17, 'Ethan Walker', 'IT', 63000.00, 38),  
(18, 'Amelia Hall', 'Finance', 54000.00, 34),  
(19, 'Mason Allen', 'HR', 77000.00, 47),  
(20, 'Harper Young', 'Sales', 49000.00, 28),  
(21, 'Elijah King', 'IT', 67000.00, 40),  
(22, 'Evelyn Wright', 'Finance', 52000.00, 35),  
(23, 'Alexander Scott', 'HR', 79000.00, 48),  
(24, 'Sofia Green', 'Sales', 51000.00, 29),  
(25, 'Daniel Adams', 'IT', 64000.00, 37),  
(26, 'Aria Baker', 'Finance', 55000.00, 32),  
(27, 'Matthew Nelson', 'HR', 80000.00, 49),  
(28, 'Scarlett Carter', 'Sales', 52000.00, 30),  
(29, 'Henry Mitchell', 'IT', 66000.00, 39),  
(30, 'Grace Perez', 'Finance', 56000.00, 33),  
(31, 'Sebastian Roberts', 'HR', 81000.00, 50),  
(32, 'Chloe Turner', 'Sales', 53000.00, 31),  
(33, 'Jack Phillips', 'IT', 68000.00, 41),  
(34, 'Victoria Campbell', 'Finance', 57000.00, 36),  
(35, 'Lucas Parker', 'HR', 82000.00, 51),  
(36, 'Lily Evans', 'Sales', 54000.00, 29),  
(37, 'Jackson Edwards', 'IT', 69000.00, 38),  
(38, 'Zoe Collins', 'Finance', 58000.00, 34),  
(39, 'Oliver Stewart', 'HR', 83000.00, 52),  
(40, 'Emily Sanchez', 'Sales', 55000.00, 30);  
...
-- Easy-Level Tasks
-- Task 1 - using alias to rename column
--Select * from Products

Select ProductName as Name from Products

-- Task 2 - using an alias to rename the Customers table

Select * from Customers as Client

-- Task 3 - Using UNION to combine 2 columns from 2 tables

Select ProductName from Products
Union
Select ProductName from Products_Discounted

-- Task 4 - Finding Intersection from 2 tables

Select * from Products
Intersect
Select * from Products_Discounted

-- Task 5 - selecting distinct customer names and their country
--Select * from Customers
...
-- Task 8 -- In the task lists, we don't have task 8. Our teacher told us to submit homework withoutit

-- Medium-Level Tasks
-- Task 9 - Using union to combine two columns from two tables

Select ProductName from Products
Union 
Select ProductName from OutOfStock

-- Task 10 - Using Except to return the difference between two tables
...
SELECT @empDept = DepartmentName FROM Employees WHERE EmployeeID = 5;  

IF @empDept = 'HR' OR 5 = 5  
BEGIN  
    UPDATE Employees  
...
-- Task 16 - Using Except to find customers who have placed orders but do not have an invoice
--Select * from Orders
--Select * from Invoices
...
-- Task 17 - using a CASE statement
