-- First inserting necesserry tables
...
Select EmployeeID, FirstName, Salary, DepartmentName, 
...
Select EmployeeID,  
       COALESCE(FirstName, LastName, 'No Name Provided') AS FullName from Employees
...
-- we can use AVG(Price) to find average
...
-- Please note that some column names may be different fromt the given task, however i have changed those wrong column names to the actual names. And there were given 27 tasks however in introduction of the task there were written 30 tasks
