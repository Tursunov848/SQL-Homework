-- Creating database for homework 10 and tables
...
Select Name as EmployeeName, Salary, DepartmentName from Employees e
...
Select FirstName, LastName, OrderDate from Customers c
...
Select Name as EmployeeName, DepartmentName from Employees e
...
Select name as Studentname, CourseName from Students s
...
-- Since there was distinct Customers who places orders i didnt use sum, if there was 1 customer who places more orders the query would be like this:

Select FirstName, LastName, sum(Quantity) Quantity from Customers c
Join Orders o on c.CustomerID = o.CustomerID 
...
Select DepartmentName, count(EmployeeID) EmployeeCount from Employees e
Join Departments d on e.DepartmentID = d.DepartmentID
...
Select FirstName, LastName, sum(Quantity) TotalQuantity from Customers c
Join Orders o on c.customerID = o.CustomerID
Group by FirstName, LastName
...
Select e1.Name Employee1, e2.Name Employee2, e1.ManagerID from Employees e1
...
Select o.OrderID, OrderDate, FirstName, LastName from Orders o
...
Select Name EmployeeName, Salary, DepartmentName from Employees e
Join Departments d on e.DepartmentId = d.DepartmentId
...
-- Task 19: In the given tasks there is no task 19. They skipped this, when told to teacher he asked to skip this part

-- Task 20
--Select * from Employees

Select name EmployeeName, salary from Employees
...
Where p.PaymentID is null and year(orderdate) < 2020
...
Select e1.Name Employee1, e2.Name Employee2, e1.ManagerID, e1.Salary Salary1, e2.Salary Salary2 
From Employees e1
Join Employees e2 on e1.ManagerID = e2.ManagerID 
...
Select SaleID, ProductName, SaleAmount from Products p
...
Where CourseName != 'Math 101' or c.CourseName is null

-- Task 27
--Select * from Orders
--Select * from Payments

Select o.OrderID, OrderDate, PaymentID from Orders o
Left join Payments p on o.OrderID = p.OrderId
